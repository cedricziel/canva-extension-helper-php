...
/**
 * Verify an incoming POST request from canva.
 *
 * @see https://www.canva.com/developers/docs/verify-post-request-signature/
 */
class PostHMACMiddleware implements MiddlewareInterface
{
    ...
    {
        if (!HttpHelper::checkPsrPostRequestSignature($request, $this->secret)) {
